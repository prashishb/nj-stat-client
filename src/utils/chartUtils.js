...
export const getChartOptions = (sortedData, title, theme) => ({
  chart: {
    type: 'line',
    backgroundColor: theme === 'dark' ? '#212529' : '#fff',
  },
  ...
  rangeSelector: {
    ...
    inputEnabled: false,
    backgroundColor: theme === 'dark' ? 'rgba(255, 255, 255, 0.1)' : '#e9ecef',
  },
  tooltip: {
    split: false,
    shared: true,
  ...
  navigator: {
    ...
    outlineWidth: 1,
    maskFill:
      theme === 'dark' ? 'rgba(130, 130, 130, 0.3)' : 'rgba(0, 0, 0, 0.1)',
    handles: {
